  ...
  <div class="scrollbar-inner">
    ...
    <div class="sidenav-header d-flex align-items-center">
      <a class="navbar-brand" href="<?= base_url('index'); ?>">
        <img src="<?= base_url('public/front/assets/img/wazte_logo.png') ?>" height="90" width="130"
          class="navbar-brand-img mt-2" alt="Wazte Logo" style="max-height: 3.5rem !important;">
      </a>
      <div class="ml-auto">
        <!-- Sidenav toggler -->
    ...
    <div class="navbar-inner">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <!-- Dashboard Link -->
          <li class="nav-item">
            <a class="nav-link<?= $dashboardActive ?>"
              href="<?= base_url(($segment1 == 'admin' || $segment1 == 'facilitator') ? $segment1 : 'admin'); ?>">
          ...
          <!-- Map Link -->
          <li class="nav-item">
            <a class="nav-link<?= $mapActive ?>"
              href="<?= base_url(($segment1 == 'admin' || $segment1 == 'facilitator') ? $segment1 . '/facility' : 'admin/facility'); ?>">
        ...
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0 text-capitalize">
              <?= ($segment2 == '' || $segment2 == 'index') ? 'Dashboard' : $segment2; ?>
            </h6>
          </div>
