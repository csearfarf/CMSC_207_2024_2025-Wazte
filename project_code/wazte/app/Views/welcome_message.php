        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-12 col-sm-8 col-md-7 col-lg-6 text-center">
                    <img src="<?= base_url('public/front/assets/img/front_logo.png') ?>" class="mb-4" height="180"
                        alt="Logo Impact">
    ...
    <div class="section pt-0">
        <div class="container mt-n10 mt-lg-n12 z-2">
            <div class="row justify-content-center">
                <div class="col-12">
                    <img src="<?= base_url('public/front.png') ?>" alt="illustration">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 mb-6 mb-lg-0 text-center ">
                    <a class="footer-brand mr-lg-5 d-flex justify-content-center align-items-center"
                        href="./index.html">
                        <img src="<?= base_url('public/front/assets/img/front_logo.png') ?>" height="95" class="ml-5"
                            alt="Footer logo">
                    </a>
